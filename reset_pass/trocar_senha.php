...
<html>
    ...
    <body>
        ...
        <main class="d-flex align-items-center justify-content-center">
            <div class="m-5">
                <form method="POST" action="salvar_nova_senha.php" class="border border-2 p-5 rounded-4" onsubmit="return ValidarPass('Pass1Input', 'Pass2Input')">
                    <div class="col mb-3">
                        <label for="validationCustomUsername" class="form-label">Nova Senha</label>
                    ...
                    <div class="d-flex mb-3">
                        <input class="btn btn-primary w-100" type="submit" name="trocar" id="trocar" value="Salvar" />
                    </div>
                </form>
            </div>
        </main>
